...
The function uploads the app PNG, JPG, or WebP into `assets/`, updates `data/apps.json`
...
list, select one app, edit its fields, optionally upload or paste a replacement PNG/JPG/WebP, and
